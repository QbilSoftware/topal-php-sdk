 ...
 */
class NumRange implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'NumRange';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('start_num', $data ?? [], null);
        $this->setIfExists('curr_num', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['start_num'];
    }

    /**
     * Sets start_num
     *
     * @param int|null $start_num start_num
     *
     * @return self
     */
    public function setStartNum($start_num)
    {
        if (is_null($start_num)) {
            throw new \InvalidArgumentException('non-nullable start_num cannot be null');
        }
        $this->container['start_num'] = $start_num;
    ...
    {
        return $this->container['curr_num'];
    }

    /**
     * Sets curr_num
     *
     * @param int|null $curr_num curr_num
     *
     * @return self
     */
    public function setCurrNum($curr_num)
    {
        if (is_null($curr_num)) {
            throw new \InvalidArgumentException('non-nullable curr_num cannot be null');
        }
        $this->container['curr_num'] = $curr_num;
