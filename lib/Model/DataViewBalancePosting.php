...
/**
 * DataViewBalancePosting Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class DataViewBalancePosting implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'DataView[BalancePosting]';
    ...
    {
        $this->setIfExists('filter_fields', $data ?? [], null);
    ...
    */
    ...
    public function setFilterFields($filter_fields)
    {
        if (is_null($filter_fields)) {
            throw new \InvalidArgumentException('non-nullable filter_fields cannot be null');
        }
    ...
    public function setOrderFields($order_fields)
    {
        if (is_null($order_fields)) {
            throw new \InvalidArgumentException('non-nullable order_fields cannot be null');
        }
