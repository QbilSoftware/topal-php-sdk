...
class VAT implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('is_input_tax', $data ?? [], null);
    ...
    */
     ...
     * @return bool|null
     */
    public function getIsInputTax()
    {
        return $this->container['is_input_tax'];
    }

    /**
     * Sets is_input_tax
     *
     * @param bool|null $is_input_tax is_input_tax
     *
     * @return self
     */
    public function setIsInputTax($is_input_tax)
    {
        if (is_null($is_input_tax)) {
            throw new \InvalidArgumentException('non-nullable is_input_tax cannot be null');
        }
        $this->container['is_input_tax'] = $is_input_tax;
