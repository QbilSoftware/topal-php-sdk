...
/**
 * PayTermDetail Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
 ...
 */
class PayTermDetail implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'PayTermDetail';
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->setIfExists('within_days', $data ?? [], null);
    ...
    */
    ...
    {
        return $this->container['within_days'];
    }

    /**
     * Sets within_days
     *
     * @param int|null $within_days within_days
     *
     * @return self
     */
    public function setWithinDays($within_days)
    {
        if (is_null($within_days)) {
            throw new \InvalidArgumentException('non-nullable within_days cannot be null');
        }
        $this->container['within_days'] = $within_days;
