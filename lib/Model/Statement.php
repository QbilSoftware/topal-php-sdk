...
class Statement implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $setters = [
        'period_balances' => 'setPeriodBalances'
    ];
    ...
    protected static $getters = [
        'period_balances' => 'getPeriodBalances'
    ];
    ...
    {
        $this->setIfExists('period_balances', $data ?? [], null);
    }
    ...
    */
    ...
    {
        return $this->container['period_balances'];
    }
     ...
     * @return self
     */
    public function setPeriodBalances($period_balances)
    {
        if (is_null($period_balances)) {
            throw new \InvalidArgumentException('non-nullable period_balances cannot be null');
        }
        $this->container['period_balances'] = $period_balances;
