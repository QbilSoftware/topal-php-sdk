...
class PartnersApi
{
    ...
    {
        list($response) = $this->partnersGetWithHttpInfo($client_id, $contentType);
        return $response;
    }
     ...
     */
    public function partnersGetAsync($client_id, string $contentType = self::contentTypes['partnersGet'][0])
    {
        return $this->partnersGetAsyncWithHttpInfo($client_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     */
    public function partnersGetRequest($client_id, string $contentType = self::contentTypes['partnersGet'][0])
    {

        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_id when calling partnersGet'
            );
        }


        $resourcePath = '/api/v1/clients/{clientId}/partners';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->partnersGet_0WithHttpInfo($id, $client_id, $contentType);
        return $response;
    }

    /**
     * Operation partnersGet_0WithHttpInfo
     *
     * Get partner by id
     *
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function partnersGet_0Async($id, $client_id, string $contentType = self::contentTypes['partnersGet_0'][0])
    {
        return $this->partnersGet_0AsyncWithHttpInfo($id, $client_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation partnersGet_0AsyncWithHttpInfo
     *
     * Get partner by id
     *
     * @param  int $id (required)
    ...
    /**
     * Create request for operation 'partnersGet_0'
     *
     * @param  int $id (required)
     * @param  string $client_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['partnersGet_0'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function partnersGet_0Request($id, $client_id, string $contentType = self::contentTypes['partnersGet_0'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling partnersGet_0'
            );
        }
        ...
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_id when calling partnersGet_0'
            );
        }


        $resourcePath = '/api/v1/clients/{clientId}/partners/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
