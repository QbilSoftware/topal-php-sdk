...
/**
 * DepreciationsApi Class Doc Comment
 *
 * @category Class
 * @package  OpenAPI\Client
 * @author   OpenAPI Generator team
...
class DepreciationsApi
{
    ...
    {
        list($response) = $this->depreciationsGetWithHttpInfo($client_id, $contentType);
        return $response;
    }

    /**
     * Operation depreciationsGetWithHttpInfo
     *
     * gets list of depreciations
     *
    ...
    /**
     * Operation depreciationsGetAsync
     *
     * gets list of depreciations
     *
     * @param  string $client_id (required)
     ...
     */
    public function depreciationsGetAsync($client_id, string $contentType = self::contentTypes['depreciationsGet'][0])
    {
        return $this->depreciationsGetAsyncWithHttpInfo($client_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation depreciationsGetAsyncWithHttpInfo
     *
     * gets list of depreciations
     *
     * @param  string $client_id (required)
    ...
    /**
     * Create request for operation 'depreciationsGet'
     *
     * @param  string $client_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['depreciationsGet'] to see the possible values for this operation
     *
     ...
     */
    public function depreciationsGetRequest($client_id, string $contentType = self::contentTypes['depreciationsGet'][0])
    {

        // verify the required parameter 'client_id' is set
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_id when calling depreciationsGet'
            );
        }


        $resourcePath = '/api/v1/clients/{clientId}/depreciations';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
    ...
    {
        list($response) = $this->depreciationsGet_0WithHttpInfo($id, $client_id, $contentType);
        return $response;
    }

    /**
     * Operation depreciationsGet_0WithHttpInfo
     *
     * Get depreciation by id
     *
    ...
    /**
     * Operation depreciationsGet_0Async
     *
     * Get depreciation by id
     *
     * @param  int $id (required)
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function depreciationsGet_0Async($id, $client_id, string $contentType = self::contentTypes['depreciationsGet_0'][0])
    {
        return $this->depreciationsGet_0AsyncWithHttpInfo($id, $client_id, $contentType)
            ->then(
                function ($response) {
                    return $response[0];
                }
    ...
    /**
     * Operation depreciationsGet_0AsyncWithHttpInfo
     *
     * Get depreciation by id
     *
     * @param  int $id (required)
    ...
    /**
     * Create request for operation 'depreciationsGet_0'
     *
     * @param  int $id (required)
     * @param  string $client_id (required)
     * @param  string $contentType The value for the Content-Type header. Check self::contentTypes['depreciationsGet_0'] to see the possible values for this operation
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    public function depreciationsGet_0Request($id, $client_id, string $contentType = self::contentTypes['depreciationsGet_0'][0])
    {

        // verify the required parameter 'id' is set
        if ($id === null || (is_array($id) && count($id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $id when calling depreciationsGet_0'
            );
        }
        ...
        if ($client_id === null || (is_array($client_id) && count($client_id) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $client_id when calling depreciationsGet_0'
            );
        }


        $resourcePath = '/api/v1/clients/{clientId}/depreciations/{id}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
